...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //ProductosAlimentarios objuno1 = new ProductosAlimentarios(100.0,10);
        //ProductosAlimentarios objuno2 = new ProductosAlimentarios(100.0,10,'C');
        ProductosAlimentarios objdos = new Bebidas(200.0,10,'N');
        ProductosAlimentarios objtres = new Refrigerados(140.0,20);
        ProductosAlimentarios objcuatro = new Bebidas(120.0,10,'I');
        ProductosAlimentarios objcinco = new Refrigerados(110.0,7);
        //System.out.println(objuno.comprobarTipoAlimento('N'));    
        System.out.println("Precio P.A " + objuno.calcularPrecio());
        
        System.out.println("Precio B " + objdos.calcularPrecio());
        System.out.println("Precio R " + objtres.calcularPrecio());
        System.out.println("Precio B " + objcuatro.calcularPrecio());
        System.out.println("Precio R " + objcinco.calcularPrecio());
        System.out.println("\n<<<<PRUEBAS 2>>>>");
